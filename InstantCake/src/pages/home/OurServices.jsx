...
const serviceLists = [
    ...
    {id:4, title: "Gift Cards", des: "Give the gift of exceptional dining with InstaCake Gift Cards", img: "/images/home/services/icon4.png"},
]
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-12">
        <div className="md:w-1/2">
          <div className="text-left md:w-4/5">
            ...
            <button className="bg-orange-900 font-bold btn text-white px-8 py-3 rounded-full">
              Explore
            </button>
          </div>
        </div>
            ...
            <div className="grid sm:grid-cols-2 grid-cols-1 gap-8 items-center">
                {
                    serviceLists.map((service) => (
                        <div key={service.id} className="shadow-md rounded-sm py-5 px-4 text-center space-y-2 text-orange-800 cursor-pointer hover:border hover:border-orange-600 transition-all duration-200">
